                        ...
                        Some(Ok(AgentEvent::Message(message))) => {
                            ...
                            if let Some(confirmation_request) = find_tool_confirmation(&message) {
                                ...
                                if permission == Permission::Cancel {
                                    ...
                                    self.agent.handle_confirmation(confirmation_request.id.clone(), PermissionConfirmation {
                                ...
                                self.agent.handle_confirmation(confirmation_request.id, PermissionConfirmation {
                                    principal_type: PrincipalType::Tool,
                                    permission,
                                }).await;
